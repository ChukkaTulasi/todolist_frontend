...
export default function Edittask() {
    ...
    const [data, setData] = useState({
      ...
      let api = 'https://todolist-frontend-silk.vercel.app//api/get_task_data/'+edit_taskid
        useEffect(() => {
...
//updating the form after click update button
  const handleSubmit = (event) => {
    ...
    const api = 'https://todolist-frontend-silk.vercel.app//api/edit_task/'+edit_taskid
